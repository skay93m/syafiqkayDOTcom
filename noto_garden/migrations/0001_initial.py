    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connections', models.ManyToManyField(blank=True, related_name='connected_notes', to='noto_garden.note')),
                ('tags', models.ManyToManyField(blank=True, related_name='notes', to='noto_garden.tag')),
            ],
            options={
                'ordering': ['-updated_at'],
            },
